...
import { Image, ImageBackground, ImageSourcePropType, StyleProp, StyleSheet, TouchableOpacity, View } from "react-native";
...
function getWarningIcon(severity?: string): ImageSourcePropType {
  return weatherIcons['icon_warning_wind_yellow'];
}

function getWarningColor(severity?: string): string {
  return 'rgba(255, 157, 0, 0.60)';
}
...
const YellowWeatherAlert = (props: WeatherAlertProps) => {
  const { onPress } = props;
      ...
      <View style={styles.glassWrapper}>
        <View style={{ ...styles.opacity, backgroundColor: getWarningColor() }}>
          <View style={styles.warning}>
            ...
            <View style={styles.warningText}><Text style={styles.header}>Expected: Strong winds{'\n'}Level: yellow</Text></View>
          </View>
        </View>
      </View>
    </TouchableOpacity>
...
export default YellowWeatherAlert;
